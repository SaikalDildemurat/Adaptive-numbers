...
(() => {
    ...
    const properties = {
        ...
        velocity: .03,
        direction: -1,
        displacement: 1 /*0-останавливает смешщение 1 включает */
    }
    ...
    class Dot {
        constructor(x, y, num) {
            this.x = x; /*w / 2 пишем сперва поптоменяем на х */
            this.y = y; /*h / 2 пишем сперва поптоменяем на y */
            this.radius = properties.dotDiameter / 2;
            this.scale = getDistance(x, y) / properties.vawelength;
            this.text = num;
        }
